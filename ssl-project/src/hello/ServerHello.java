...
public class ServerHello extends Hello{
    ...
    public ServerHello(DataInputStream in, DataOutputStream out){
        super(in, out);
    }
    ...
    public void init(){
        ...
        keyExchange.add("RSA"); keyExchange.add("DH");
        ...
        super.sendMsgHSProtcol("2", makeServerHello(randomFromServer));
    ...
    private void algorithmMatching(String message) {
        ...
        // Throw an error if now matching algorithms are found
